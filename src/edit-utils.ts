...
export function isWrappingDocChange(change: DocChange | WrappingDocChange): change is WrappingDocChange {
    return "firstEdit" in change;
}

export function isDocChange(change: DocChange | WrappingDocChange): change is DocChange {
