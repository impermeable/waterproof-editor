            ...
            if (languageConfig !== undefined) {
              return syntaxHighlighting(
                initialThemeStyle === ThemeStyle.Light
                  ? languageConfig.highlightLight
                  : languageConfig.highlightDark,
              );
            }
            return [];
          })(),
          ...
          if (this.languageConfig !== undefined) {
            return syntaxHighlighting(
              theme === ThemeStyle.Light
                ? this.languageConfig.highlightLight
                : this.languageConfig.highlightDark,
            );
          }
          return [];
        })(),
