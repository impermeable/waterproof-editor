 ...
 * @returns An insertion transaction.
 */
export function insertCompositeNodeAbove(state: EditorState, tr: Transaction, wrappedNodeType: NodeType, wrapNodeType: NodeType | undefined, tagConf: TagConfiguration, hintTitle: string = "💡 Hint", content: string = ""): Transaction | undefined {
    const sel = state.selection;
    let trans: Transaction = tr;
