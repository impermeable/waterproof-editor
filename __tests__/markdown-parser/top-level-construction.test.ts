...
import { typeguards, MarkdownBlock, BlockRange } from "../../src";
import { parse as parseRocq } from "../../src/markdown-defaults";

const parse = (str: string) => parseRocq(str, { language: "coq" });
